...
const hexagonNumbers = [
    [1, 6, 3, 2, 4, 5, 6, 2, 5, 2, 1, 3, 4, 5, 3, 5, 1, 1, 3],
    [2, 3, 2, 6, 5, 4, 1, 4, 3, 7, 4, 4, 2, 1, 1, 5, 6, 2, 2],
    [4, 3, 3, 1, 2, 1, 4, 5, 2, 3, 5, 1, 3, 5, 2, 2, 2, 3, 3],
    [6, 1, 2, 3, 5, 6, 2, 3, 4, 3, 1, 5, 3, 2, 3, 4, 6, 4, 3],
    [3, 1, 2, 6, 3, 7, 2, 4, 2, 2, 3, 6, 7, 3, 4, 1, 5, 6, 1],
    [2, 3, 5, 4, 4, 5, 1, 2, 8, 3, 5, 4, 4, 5, 7, 2, 8, 1, 1],
    [6, 5, 2, 4, 3, 4, 2, 2, 5, 5, 3, 6, 7, 5, 1, 4, 1, 1, 2],
    [6, 7, 5, 5, 1, 10, 10, 4, 4, 6, 8, 6, 10, 9, 1, 1, 4, 2, 10],
    [4, 7, 1, 4, 3, 3, 5, 6, 3, 2, 5, 2, 2, 6, 1, 1, 1, 2, 5],
    [5, 6, 5, 7, 8, 1, 6, 4, 4, 2, 3, 3, 4, 6, 6, 7, 4, 1, 8]
];
const targetNumbers = [5, 7, 6, 9, 8, 12, 10, 18, 11, 15];
